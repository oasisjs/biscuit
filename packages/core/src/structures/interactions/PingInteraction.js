...
class PingInteraction extends BaseInteraction_1.default {
    ...
    async pong() {
        await this.session.rest.runMethod(this.session.rest, 'POST', Routes.INTERACTION_ID_TOKEN(this.id, this.token), {
            type: api_types_1.InteractionResponseTypes.Pong,
        });
    }
}
exports.PingInteraction = PingInteraction;
