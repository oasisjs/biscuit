import type { ApplicationCommandPermissionTypes, AtLeastOne, DiscordApplicationCommand, DiscordApplicationCommandOption, DiscordGuildApplicationCommandPermissions, GatewayBot, GatewayIntents, Localization } from '../discordeno/mod';
...
import { ApplicationCommandTypes, createGatewayManager, createRestManager } from '../discordeno/mod';
...
export declare class Session extends EventEmitter {
    ...
    upsertApplicationCommands(options: Array<UpsertApplicationCommands | CreateContextApplicationCommand>, guildId?: Snowflake): Promise<DiscordApplicationCommand[]>;
