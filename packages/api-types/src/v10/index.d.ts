import type { ActivityTypes, AllowedMentionsTypes, ApplicationCommandOptionTypes, ApplicationCommandPermissionTypes, ApplicationCommandTypes, ApplicationFlags, AuditLogEvents, ButtonStyles, ChannelFlags, ChannelTypes, DefaultMessageNotificationLevels, EmbedTypes, ExplicitContentFilterLevels, GatewayEventNames, GuildFeatures, GuildNsfwLevel, IntegrationExpireBehaviors, InteractionTypes, Localization, MessageActivityTypes, MessageComponentTypes, MessageTypes, MfaLevels, OverwriteTypes, PickPartial, PremiumTiers, PremiumTypes, ScheduledEventEntityType, ScheduledEventPrivacyLevel, ScheduledEventStatus, StickerFormatTypes, StickerTypes, SystemChannelFlags, TargetTypes, TeamMembershipStates, TextStyles, UserFlags, VerificationLevels, VideoQualityModes, VisibilityTypes, WebhookTypes } from '../common';
...
export declare type DiscordWebhook = DiscordIncomingWebhook | DiscordApplicationWebhook;
...
export declare type DiscordMessageComponents = DiscordActionRow[];
...
export declare type DiscordInteractionDataOption = {
...
export declare type DiscordAuditLogChange = {
    new_value: string;
    old_value: string;
    key: 'name' | 'description' | 'discovery_splash_hash' | 'banner_hash' | 'preferred_locale' | 'rules_channel_id' | 'public_updates_channel_id' | 'icon_hash' | 'image_hash' | 'splash_hash' | 'owner_id' | 'region' | 'afk_channel_id' | 'vanity_url_code' | 'widget_channel_id' | 'system_channel_id' | 'topic' | 'application_id' | 'permissions' | 'allow' | 'deny' | 'code' | 'channel_id' | 'inviter_id' | 'nick' | 'avatar_hash' | 'id' | 'location' | 'command_id';
} | {
    new_value: number;
    old_value: number;
    key: 'afk_timeout' | 'mfa_level' | 'verification_level' | 'explicit_content_filter' | 'default_message_notifications' | 'prune_delete_days' | 'position' | 'bitrate' | 'rate_limit_per_user' | 'color' | 'max_uses' | 'uses' | 'max_age' | 'expire_behavior' | 'expire_grace_period' | 'user_limit' | 'privacy_level' | 'auto_archive_duration' | 'default_auto_archive_duration' | 'entity_type' | 'status' | 'communication_disabled_until';
} | {
    ...
    new_value: boolean;
    old_value: boolean;
    key: 'widget_enabled' | 'nsfw' | 'hoist' | 'mentionable' | 'temporary' | 'deaf' | 'mute' | 'enable_emoticons' | 'archived' | 'locked' | 'invitable';
} | {
...
export interface DiscordTemplate {
    ...
    serialized_source_guild: Omit<PickPartial<DiscordGuild, 'name' | 'description' | 'verification_level' | 'default_message_notifications' | 'explicit_content_filter' | 'preferred_locale' | 'afk_timeout' | 'channels' | 'afk_channel_id' | 'system_channel_id' | 'system_channel_flags'>, 'roles'> & {
        roles: (Omit<PickPartial<DiscordRole, 'name' | 'color' | 'hoist' | 'mentionable' | 'permissions' | 'icon' | 'unicode_emoji'>, 'id'> & {
            id: number;
        })[];
    };
...
export declare type DiscordMessageReactionRemoveEmoji = Pick<DiscordMessageReactionAdd, 'channel_id' | 'guild_id' | 'message_id' | 'emoji'>;
