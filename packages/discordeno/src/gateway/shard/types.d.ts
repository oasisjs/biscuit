import type { DiscordGatewayPayload, GatewayOpcodes } from '@biscuit/api-types';
import type { createShard } from './createShard';
export declare const MAX_GATEWAY_REQUESTS_PER_INTERVAL = 120;
export declare const GATEWAY_RATE_LIMIT_RESET_INTERVAL = 60000;
export declare const DEFAULT_HEARTBEAT_INTERVAL = 45000;
export declare type Shard = ReturnType<typeof createShard>;
