...
import type { Shard, ShardEvents, ShardGatewayConfig, ShardHeart, ShardSocketRequest } from './types';
...
import type { DiscordGatewayPayload, DiscordStatusUpdate, PickPartial } from '@biscuit/api-types';
...
export declare function createShard(options: CreateShard): {
    ...
    makePresence: ((shardId: number) => DiscordStatusUpdate | Promise<DiscordStatusUpdate>) | undefined;
