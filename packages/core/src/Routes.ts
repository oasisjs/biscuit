...
export function MESSAGE_CREATE_THREAD(
	channelId: Snowflake,
	messageId: Snowflake
): string {
...
export function CHANNEL_MESSAGES(
	channelId: Snowflake,
...
export function CHANNEL_MESSAGE(
	channelId: Snowflake,
	messageId: Snowflake
): string {
...
export function AUTO_MODERATION_RULES(
	guildId: Snowflake,
	ruleId?: Snowflake
): string {
	if (ruleId) {
...
export function INTERACTION_ID_TOKEN(
...
export function WEBHOOK_MESSAGE_ORIGINAL(
	webhookId: Snowflake,
	token: string,
...
export function CHANNEL_MESSAGE_REACTION_ME(
	channelId: Snowflake,
	messageId: Snowflake,
	emoji: string
): string {
...
export function CHANNEL_MESSAGE_REACTIONS(
	channelId: Snowflake,
	messageId: Snowflake
) {
...
export function CHANNEL_MESSAGE_CROSSPOST(
	channelId: Snowflake,
	messageId: Snowflake
): string {
...
export function GUILD_MEMBER_ROLE(
	guildId: Snowflake,
	memberId: Snowflake,
	roleId: Snowflake
): string {
...
export function THREAD_START_PUBLIC(
	channelId: Snowflake,
	messageId: Snowflake
): string {
	return `/channels/${channelId}/messages/${messageId}/threads`;
...
export function THREAD_ARCHIVED_PUBLIC(
	channelId: Snowflake,
...
export function THREAD_ARCHIVED_PRIVATE(
	channelId: Snowflake,
	options?: ListArchivedThreads
): string {
...
export function THREAD_ARCHIVED_PRIVATE_JOINED(
	channelId: Snowflake,
	options?: ListArchivedThreads
): string {
...
export function APPLICATION_COMMANDS(
	appId: Snowflake,
	commandId?: Snowflake
): string {
	if (commandId) {
...
export function GUILD_APPLICATION_COMMANDS(
	appId: Snowflake,
	guildId: Snowflake,
	commandId?: Snowflake
): string {
...
export function GUILD_STICKERS(
	guildId: Snowflake,
	stickerId?: Snowflake
): string {
	if (stickerId) {
 ...
 * @link https://discord.com/developers/docs/resources/guild#get-guild-widget-settings
 */
export function GUILD_WIDGET(
	guildId: Snowflake,
	options: GetWidget = { get: 'settings' }
): string {
